...
function sendResetEmail($email, $token) {
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'srsandeep356@gmail.com'; // Your email
        $mail->Password = 'Sandeep@123'; // Your email password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
        $mail->Port = 587;

        $mail->setFrom('sandeep356@gmail.com', 'Career Bridge'); // Your email and name
